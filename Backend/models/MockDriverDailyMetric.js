...
const mockDriverDailyMetricsSchema = new mongoose.Schema({
    ...
    collection: 'mock_driver_daily_metrics'
});

mockDriverDailyMetricsSchema.index({ driver_id: 1, date: 1 }, { unique: true });

const MockDriverDailyMetric = mongoose.model('MockDriverDailyMetric', mockDriverDailyMetricsSchema);

module.exports = MockDriverDailyMetric;
